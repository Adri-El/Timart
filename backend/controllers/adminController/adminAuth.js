  ...
  try{
    ...
    if(utilities.validator(payload, ['oldPassword', 'newPassword']).isValid){
      ...
      if(payload.oldPassword === adminObj.password){
        ...
        await email.sendOtp('timartltd@gmail.com', adminObj.email, "OTP Verification", `hello ${adminObj.username}, please verify your email with this OTP:`, newOtp)
  ...
  try{
    ...
    if(utilities.validator(payload, ['email', 'password']).isValid){
      ...
      if(payload.password === adminObj.password){
        ...
        await email.sendOtp('timartltd@gmail.com', payload.email, "OTP Verification", `hello ${adminObj.username}, please verify your email with this OTP:`, newOtp)
