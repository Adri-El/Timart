...
adminController.TraderVerificationDocsVerdict = ('/trader-verification-docs-verdict', async (req, res)=>{
    ...
    try{
        ...
        if(payload.approved){
            ...
            const msg = `Dear customer, the timart team is pleased to inform you that your verification 
            documents were approved and so you can now create shops. thanks for choosing timart. ☺`

            await email.sendToUsers("timartltd@gmail.com", trader.email, "Verification Verdict", msg)
