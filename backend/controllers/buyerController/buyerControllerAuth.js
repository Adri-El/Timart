...
buyerControllerAuth.resendOtp = ('/signup/resend-otp', async (req, res)=>{
  ...
  try{
    ...
    await email.sendOtp('timartltd@gmail.com', pendingBuyerObj.email, "OTP Verification", `hello ${pendingBuyerObj.firstName} ${pendingBuyerObj.lastName}, please verify your email with this OTP:`, newOtp)
  ...
  try{
    ...
    if(utilities.validator(payload, ['email', 'newPassword']).isValid){
      ...
      if(buyerObj){
        ...
        await email.sendOtp('timartltd@gmail.com', payload.email, "OTP Verification", `hello ${buyerObj.firstName} ${buyerObj.lastName}, please verify your email with this OTP:`,  newOtp)
